...
<body>
            ...
            <div class="col-md-12" id="pos">
                <div class="pos-receipt">
                    <div class="pos-receipt-header">
                        ...
                        <div><a href="https://deomezesupermarket.com.ng" target="_blank">deomezemart.com.ng</a></div>
                        <h3><strong> {{ Auth::user()->store->name }}</strong></h3>
                        <div class="cashier">Served by: <strong>{{ Auth::user()->name }}</strong></div>
                        <div><strong>Store ID:</strong> {{ Auth::user()->store_id }}</div>
                        <!-- <div><strong>Store Name:</strong> {{ Auth::user()->store->name }}</div> -->
                    </div>
    ...
    <a href="#" id="newOrder" class="btn btn-primary btn-lg">New Order</a>
