...
<main class="flex flex-col md:flex-row h-screen">
    ...
    <div class="cart-fixed bg-white p-4 rounded shadow-md w-full md:w-80 lg:w">
    ...
    <div class="content-wrapper flex-1 p-2 mt-16">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-16" id="product-list">
