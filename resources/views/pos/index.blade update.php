              ...
              <div class="flex items-center gap-2">
                <div class="flex items-center rounded-lg border border-gray-200 overflow-hidden">
                  ...
                  <input type="number" min="1"
                         ...
                         @input="saveCart()"
                         @click.stop>
                  <button @click.stop="item.quantity++; saveCart();"
                          class="px-2 py-1 hover:bg-gray-100 text-gray-600">
          ...
          <div class="flex justify-between items-center">
            ...
            <div class="flex items-center gap-4">
              <div class="flex items-center gap-2">
                ...
                <div>
                  <span class="text-lg font-bold bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent">ModernPOS</span>
